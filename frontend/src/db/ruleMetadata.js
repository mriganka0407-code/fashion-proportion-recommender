...
export const ruleMetadata = {
    ...
    // AVOIDANCE / NEGATIVE RULES (Diplomatic)
    "MINIMIZE_EMPHASIS": {
        label: "Refining",
        explanation: "This style is usually avoided to prevent over-emphasizing your {bodyFeature}."
    },
    "AVOID_VERTICAL_BREAK": {
        label: "Streamlining",
        explanation: "A different cut might better avoid an abrupt visual break at your {bodyFeature}."
    },
    "AVOID_VOLUME_OVERLOAD": {
        label: "Proportions",
        explanation: "We've de-prioritized this to avoid adding unnecessary volume to your {bodyFeature}."
    }
};
...
export function generateExplanation(ruleType, clothingValue, bodyFeatureLabel) {
    ...
    const featureLabels = {
        ...
        "longLegs": "leg length",
        "denseUpperTorso": "upper chest area",
        "lightUpperTorso": "upper frame",
        "highProjection": "bustlineline",
        "lowProjection": "chest profile"
    };
